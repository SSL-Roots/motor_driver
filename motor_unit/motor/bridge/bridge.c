...
extern void driveBridge(unsigned char phase)
{
    switch(phase){
    case EXCITATION_3_2:
        OverrideMCPWM1(FET_2H & FET_2H_OFF & FET_2L & FET_2L_ON & FET_1H
                & FET_1H_OFF & FET_1L & FET_1L_OFF);
        break;

    case EXCITATION_1_2:
        OverrideMCPWM1(FET_2H & FET_2H_OFF & FET_2L & FET_2L_ON & FET_3H
                & FET_3H_OFF & FET_3L & FET_3L_OFF);
        break;

    case EXCITATION_1_3:
        OverrideMCPWM1(FET_3H & FET_3H_OFF & FET_3L & FET_3L_ON & FET_2H
                & FET_2H_OFF & FET_2L & FET_2L_OFF);
        break;

    case EXCITATION_2_3:
        OverrideMCPWM1(FET_3H & FET_3H_OFF & FET_3L & FET_3L_ON & FET_1H
                & FET_1H_OFF & FET_1L & FET_1L_OFF);
        break;

    case EXCITATION_2_1:
        OverrideMCPWM1(FET_1H & FET_1H_OFF & FET_1L & FET_1L_ON & FET_3H
                & FET_3H_OFF & FET_3L & FET_3L_OFF);
        break;

    case EXCITATION_3_1:
        OverrideMCPWM1(FET_1H & FET_1H_OFF & FET_1L & FET_1L_ON & FET_2H
                & FET_2H_OFF & FET_2L & FET_2L_OFF);
        break;

    case EXCITATION_BRAKE:
        OverrideMCPWM1(FET_1L & FET_1L_ON & FET_2L & FET_2L_ON
                & FET_3L & FET_3L_ON);
        break;
